...
\begin  {figure} [h] 
\centering
\includegraphics[width=0.4\textwidth]{figures/Gant.JPG}
...
Na podstawie \hyperref[eq:sum_can]{Wzoru~\ref*{eq:sum_can}} obliczono ca³kowit¹ iloœæ wiadomoœci w systemie równ¹ 127. Oznacza to ¿e czas miêdzy kolejnymi wiadomoœciami musi byæ 127 d³u¿szy ni¿ czas przetwarzania wiadomoœci.
