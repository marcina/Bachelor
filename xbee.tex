...
Jedn¹ z mo¿liwoœci obs³ugi modu³u XBee jest u¿ycie modu³u Universal Asynchronous Receiver and Transmitter ($UART$). Protokó³ obs³ugi modu³u jest podobny do protoko³u RS232. Komunikacja jest dwukierunkowa (full duplex), szeregowa i asynchroniczna. W warstwie fizycznej to przede wszystkim dwie linie danych:
\begin{itemize}
\item DIN - Data In
\item DOUT - Data Out
\end{itemize}
