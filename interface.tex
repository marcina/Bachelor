...
W œrodowisku Visual Studio zosta³ stworzony interfejs u¿ytkownika. Zadaniem GUI jest monitorowanie magistrali CAN oraz akwizycja danych przesy³anych przez UART do programu. Program mo¿e dzia³aæ w dwóch trybach:\newline
...
Zdecydowano siê na komunikacje $UART$ w zwi¹zku z du¿¹ liczb¹ modu³ów bezprzewodowych obs³uguj¹cych ten typ transmisji. Obs³uga komunikacji realizowana jest przez kontrolkê $SerialPort$, która jest czêœci¹ œrodowiska Visual Studio. Dostarcza ona metod pozwalaj¹cych na ³atw¹ obs³ugê portu szeregowego.
