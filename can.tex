...
CANH & $2.5V$ & $3.5V$ \\ \hline
CANL & $2.5V$ & $1.5V$ \\ \hline
\begin{tabular}[c]{@{}l@{}}dopuszczalne\\ napiêcie\\ ró¿nicowe\\ $U_{0}=CANH-CANL$\end{tabular} & $0-0.5V$ & $0.9-2.0V$ \\ \hline
\end{tabular}
\end{center}
...
Czas trwania jednego przesy³anego bitu podzielony jest na segmenty widoczne na (\hyperref[fig:timing]{Rysunku~\ref*{fig:timing}}):
